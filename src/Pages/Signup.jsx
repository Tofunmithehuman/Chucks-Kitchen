...
const SignUp = () => {
  ...
  return (
    <div>
      <div>
        <div className="flex lg:h-screen bg-white md:bg-[#F3F4F6]">
              ...
              >
                <div>
                  ...
                  <motion.div variants={formItemVariants}>
                    ...
                    >
                      <img src={call} alt="phone" className="ms-4" />
                      <input
                        type="number"
                  ...
                  <motion.div className="my-4" variants={formItemVariants}>
                    <label
                      htmlFor="remember"
                  ...
                  >
                    ...
                    <motion.p className="text-xs" variants={formItemVariants}>
                      ...
                      >
                        <Link
                          to="/signin"
                          className="ms-1 text-[#1E88E5] hover:underline"
                        >
                          Sign In
                        </Link>
                      </motion.span>
