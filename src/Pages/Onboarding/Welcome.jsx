      ...
      <div>
        <div className="flex h-screen">
          ...
          <div className="w-full lg:w-1/2">
            <motion.div
              className="w-full max-w-xl mx-auto sm:py-6 px-6 sm:px-10 flex flex-col justify-center min-h-screen"
              initial="hidden"
              animate="visible"
            ...
            >
              ...
              >
                ...
                >
                  <Link
                    to="/signin"
                    className="text-[#1E88E5] border-2 border-[#1E88E5] rounded-lg w-26 h-10 text-sm flex items-center justify-center text-center transition-colors hover:bg-[#1E88E5] hover:text-white duration-300"
                  >
                    Sign In
                  </Link>
                </motion.div>
              ...
              <div className="py-8">
                ...
                >
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <Link className="text-xs bg-[#FF7A18] w-full rounded-lg h-12 flex items-center justify-center text-center text-white font-semibold hover:bg-[#FF8C3A] transition-all duration-300">
                      Start Your Order
                    </Link>
                  </motion.div>
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <Link className="text-xs border-2 border-[#1E88E5] w-full rounded-lg h-12 flex items-center justify-center text-center text-[#1E88E5] font-semibold hover:bg-[#1E88E5] hover:text-white transition-all duration-300">
                      Learn More About Us
                    </Link>
                  </motion.div>
                </motion.div>
              ...
              >
                ...
                <div className="flex items-center justify-center gap-4 mt-4 text-xs py-4">
